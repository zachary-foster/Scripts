...
command_line_parser.add_argument('--comment-char', metavar='CHAR', default = default_comment_char, help='Character or string that indicates a line is a comment and should be ignored. Default: none')
